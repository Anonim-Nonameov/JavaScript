...
i = 0; // обнуляем наш цикл, делая его значение равным нулю
while (i < 10) {
...
// Итак, разберем логику нашего кода: сначала обрабатывается переменная i, значение которой
// становится равной нулю. Далее, у цикла while проверяется условие - "пока i меньше 10",
// цикл видит это условие и если оно равно true, то позвляет коду находящемуся в фиг. скобках
// выполняться, работать. А в фиг. скобках мы выводим в консоль значение итератора,
// а затем увеличиваем его на 1 каждую итерацию.

// Вот и всё! Остальное допишу.. позже.