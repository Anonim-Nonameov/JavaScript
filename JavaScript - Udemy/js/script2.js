...
// вывел его в консоль! но есть еще одна очень важная информация, которую мы
// должны знать и помнить - это классификация функций. Дело в том, что мы
// можем записать функции в виде "Function Expression" и "Function Declaration".
// Что это значит? ну, если говорить "человечьим" (:D) языком, то мы либо функцию
// объявляем самым обычным способом, а это Function Declaration, либо записываем
// её в формате функционального выражения. Например, возьмем те три функции, ко-
// торые мы объявили ранее - это и есть Function Declaration, объявление функции.
...
// что мы можем использовать функции до их создания в коде. Ну а что - теоретически
// наша функция уже существует, по крайней мере "её призрак" :D

// А на этом пока что всё.. продолжим мы позже!)