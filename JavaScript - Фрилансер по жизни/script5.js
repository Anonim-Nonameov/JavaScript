...
newElement.innerHTML = `Я самый <span class="yellow">важный</span> текст на сайте!
другие текста - пародии, так и знайте.`;
console.log(newElement);
// => <div>...</div>
...
// у него максимально простецкий - ...

// Какой же? узнаем, конечно, но не сегодня а чуть позже!)