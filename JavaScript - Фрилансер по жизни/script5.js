...
// но что нам делать, когда речь пойдет о CSS? сейчас мы с вами научимся менять
// стили элемента из JS файла также легко, как мы с вами меняем HTML-код!

// Стили и классы: className & classList

// Об этом мы поговорим позже (конспект получился маленьким на этот раз, извиняюсь!)