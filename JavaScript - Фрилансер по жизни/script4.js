...
// мы видим и комментарии и текст, которые ТОЖЕ являются частью дерева DOM. Итак, HTML документы
...
// Но как же так?! первый элемент ведь h1! - всё дело в том, что после знака ">" (<body>) идет разрыв
