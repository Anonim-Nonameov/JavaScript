...
// Использовать его просто - синтаксис у него 100% такой же, как и у пред. метода
// querySelectorAll - в круглых скобках вписывается селектор, по которому метод
// будет искать необходимые нам элементы. Но найдет он лишь 1 элемент (или 0,
// если такого нет), самый первый. Допустим, мы ищем элемент с классом "abc",
...
// понять - надо применить! будем применять, значит :)

// А применять его мы будем позже!)