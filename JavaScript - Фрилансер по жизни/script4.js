...
// "Мертвая" коллекция или "querySelectorAll возвращает статичную коллекцию!"
...
// заиспользуем метод forEach!

// А использовать его мы будем позже :) (да и к тому же я не особо помню как он работает, так щто...)