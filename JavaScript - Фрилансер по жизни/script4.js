...
// браузерном окружении, DOM (или же "Document Object Model", или "Объектная модель
// документа"). Урок ОГРОМНЫЙ - идет он целый час (тема - важная). Но что мы ужзнаем
...
// Для начала разберемся, что же такое "браузерное окружение"! А начнем с того, что 
...
// и прокруткой - но обо всём этом позже, а пока продолжим знакомиться с БО.
